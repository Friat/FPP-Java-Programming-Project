...
class Q4
{
	...
	{
		Manager m= new Manager("Friat Mehari",98922,"SN1234",LocalDate.of(1988,8,3),"California");
		Secretary4 s = new Secretary4("Eden Mehari",1256,"SN45645",LocalDate.of(1996,03,24),"Ethiopia");
